...
export const Hero = () => {
  return (
    <div 
      className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 relative overflow-hidden bg-background"
    >
      <div className="relative z-10 max-w-7xl mx-auto w-full pt-24">
        <div className="flex flex-col items-center gap-8">
          <div className="max-w-4xl">
            ...
            />
            <h1 className="text-3xl md:text-5xl font-bold mb-6 dark:text-[#F9F6EE] text-[#36454F]">
              Create and Evaluate Job Assessments using AI
            </h1>
            <h2 className="text-xl md:text-2xl mb-6 dark:text-[#F0EAD6] text-[#36454F]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto mb-8">
              ...
              <Button 
                size="lg" 
                className="bg-[#006BFF] hover:bg-[#0055CC] text-white font-semibold whitespace-nowrap h-12"
              >
                Create Assessment
              </Button>
            </div>
