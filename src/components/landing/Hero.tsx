      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center gap-8">
          <div className="text-shadow-lg max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-bold mb-6 drop-shadow-lg text-testera-heading">
            ...
            <p className="text-xl md:text-2xl text-testera-subheading drop-shadow-lg font-medium">
